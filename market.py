...
def fetch_data(symbol="bnb", timeframe="1h", limit=100):
    """
...
def fetch_historical_data(symbol="bnb", timeframe="1h", days=14):
    """
    Utiliza fetch_data para obtener datos históricos que se puedan analizar.
    """
